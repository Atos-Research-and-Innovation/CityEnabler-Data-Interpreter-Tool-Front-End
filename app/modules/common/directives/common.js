angular.module('pcApp.common.directives.common', [])
	...
	.directive('plotorganizationname', [
        '$log', 'API_CONF', function ($log, API_CONF) {
            return {
                ...
                controller: function ($scope, $element, $attrs, $location, dialogs, GetCityEnablerCompanyData, API_CONF) {

					$scope.nameToPlot = 'loading...';
					//$scope.nameToPlot = 'Error. ID='+$scope.id;
					
					 $scope.loadCompanyData = function (id) {						
						GetCityEnablerCompanyData.get({id: id}, function (CompanyData) {
							$scope.nameToPlot = CompanyData.name;
						}, function (error) {
							$scope.nameToPlot = 'Error. ID='+$scope.id;
					...
					$scope.$watch('id', function() {
						if ($scope.id) {
        					$scope.loadCompanyData($scope.id);
        				}
    				});
    ...
    .directive('editButtons', [
        ...
        <a type="button" ng-if="allowEdit()" class="btn btn-primary btn-create" href="{{editurl}}"> {{ \'Edit\' | translate }}</a>\
        <a type="button" ng-if="allowEdit()" class="btn btn-danger" ng-click="deletefunction();">{{ \'Delete\' | translate }}</a></div>\
        </div>',
                link: function (scope) {
