    ...
    .directive('pcLinesChart', [
        '$log', 'API_CONF', function ($log, API_CONF) {
            ...
            return {
                ...
                template: '' + '<div id="directive_container_lineschart_{{chartid}}" class="{{xaxeformat}} pcchart container_graph directive_container_chart directive_container_chart_{{chartid}}">' + '<div class="loading-container">' + '<div ng-hide="small">' + '<div class="loading"></div>' + '<div id="loading-text">loading</div>' + '</div>' + '<div ng-show="small">' + '<div class="loading loading-small"></div>' + '<div id="loading-small-text">loading</div>' + '</div>' + '</div>' + '</div>' + '<div ng-hide="small" id="showFilterContainer" class="showFilterContainer">' + '<div id="showFilter" class="showFilter on_check">' + '<input type="hidden" name="disableindividuals" id="disableindividuals_{{chartid}}"><label class="checkbox-inline"><input ng-model="showLegend" type="checkbox" name="showLegend" class="checkbox filterCheckBox"> {{ \'Show Legend\' | translate }}</label>' + '<label class="checkbox-inline"><input ng-model="showLines"  type="checkbox" name="showLines"  class="checkbox filterCheckBox"> {{ \'Show Lines\' | translate }}</label>' + '<label class="checkbox-inline"><input ng-model="showAreas"  type="checkbox" name="showAreas"  class="checkbox filterCheckBox"> {{ \'Show Areas\' | translate }}</label>' + '<label class="checkbox-inline"><input ng-model="showPoints" type="checkbox" name="showPoints" class="checkbox filterCheckBox"> {{ \'Show Points\' | translate }}</label>' + '<label class="checkbox-inline"><input ng-model="showLabels" type="checkbox" name="showLabels" class="checkbox filterCheckBox"> {{ \'Show Labels\' | translate }}</label>' + '<label class="checkbox-inline"><input ng-model="showGrid"   type="checkbox" name="showGrid"   class="checkbox filterCheckBox"> {{ \'Show Grid\' | translate }}</label>' + '<label class="checkbox-inline"><input ng-model="showTogether"  type="checkbox" name="showTogether"  class="checkbox filterCheckBox"> {{ \'Show only one Y axe\' | translate }}</label>' 
                + '<label class="checkbox-inline"><input ng-model="showPercentatge" type="checkbox" name="showPercentatge" class="checkbox filterCheckBox"> {{ \'Show as %\' | translate }}</label>' 
                + '<label ng-show="events.length>0" class="checkbox-inline"><input ng-model="showAstoplines" type="checkbox" name="showAstoplines" class="checkbox filterCheckBox"> {{ \'Events on top\' | translate }}</label>'
                + '</div>' + '</div>'
            };
        }
    ]);
