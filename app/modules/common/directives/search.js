 ...
 *******/
    .directive('selectorDatasets', [
        '$log', 'searchclient', 'API_CONF', '$filter', function ($log, searchclient, API_CONF, $filter) {
            ...
            return {
                ...
                controller: function ($scope, $element, $attrs, $location, dialogs, Auth) {
...
/*
                ...
                */
                ...
                '<div ng-show="!showerrormessage">' +
	                        ...
	                        '<div class="row">' +
	                            '<div class="col-sm-4">' +
	                            	'<div class="form-group ng-scope">' +
	                                	'<label for="filterEvent">{{ \'Search text\' | translate }}</label>' +
	                                	'<p class="input-group">' +
	                                		'<input ng-keyup="$event.keyCode == 13 && findDatasetsByFilter(\'1\')" placeholder="{{ \'--all datasets--\' | translate }}" ng-model="searchtext" type="text" id="filterDatasetDirective" class="form-control ng-isolate-scope ng-pristine ng-valid-required ng-valid">' +
                    ...
                    '<div>' +
                    	'<div>' +
                    		'<label ng-show="datasetsFilter.hits.total>1" for="">{{datasetsFilter.hits.total}} {{ \'datasets found\' | translate }}</label>' +
                    		'<label ng-show="datasetsFilter.hits.total==1" for="">{{datasetsFilter.hits.total}} {{ \'dataset found\' | translate }}</label>' +
                    		'<label ng-show="datasetsFilter.hits.total==0" for="">{{ \'no datasets found\' | translate }}</label>' +
                    	'</div>' +
